...
describe('Trifid', () => {
  ...
  it('should register a resolver for cwd which uses the cwd as base path', () => {
    const trifid = new Trifid()
  ...
  it('should register a resolver for env which resolves based on environment variables', () => {
    const trifid = new Trifid()
  ...
  it('should register a resolver for env which returns an empty string if the environment variable is not set', () => {
    const trifid = new Trifid()
  ...
  it('should register a resolver for trifid-core which uses the trifid-core root as base path', () => {
    const trifid = new Trifid()
