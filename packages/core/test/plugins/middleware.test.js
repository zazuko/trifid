...
describe('middleware', () => {
  ...
  it(
    'should create a single instance of the middleware and add it to the router',
    async () => {
      const app = express()
  ...
  it(
    'should create middleware with .call and forward config if no params are given',
    async () => {
      const app = express()
