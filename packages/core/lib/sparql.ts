 ...
 *
 * @param jsonLD JSON-LD object to convert to CSV
 * @returns CSV string
 */
 ...
 *
 * @param quadStream The formatted stream to serialize.
 * @returns The serialized string.
 */
export const serializeFormattedStream = async (
 ...
 *
 * @param quadStream The quad stream to serialize.
 * @param mimeType The mime type to serialize to.
 * @param _options Options (reserved for further use).
 * @returns The serialized string.
 */
export const serializeQuadStream = async (
  quadStream: Stream<Quad> | null,
  mimeType: string,
 ...
 */
export const generateClient = (sparqlEndpoint: string, options: QueryOptions): SPARQLClient => {
  const clients = {
  ...
  /**
   *
   * @param query The SPARQL query to use.
   * @param options Query options.
   * @returns The quad stream or boolean for ASK queries.
   */
  const query = async (
    query: string,
 ...
 * @param configuredEndpoints Configured endpoints.
 * @param instanceHostname Instance hostname, used to resolve relative URLs.
