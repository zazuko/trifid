...
const factory = (trifid) => {
  ...
  if (sparqlEndpoint) {
    ...
    const hasProperties = Object.hasOwnProperty.call(sparqlEndpoint, 'username') && Object.hasOwnProperty.call(sparqlEndpoint, 'password')
    if (hasProperties && sparqlEndpoint.username !== '' && sparqlEndpoint.password !== '') {
